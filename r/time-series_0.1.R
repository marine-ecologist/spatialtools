 ...
 # deployApp(appDir="/Users/rof011/spatialtools/apps/time-series/",
 #           appPrimaryDoc="time-series_0.1.R", appName="Interactive-Ocean-Data", appTitle="Interactive-Ocean-Data")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      ### Set date
      dateInput("date", HTML(paste(fa("calendar"), "Date:")), value = Sys.Date() - 21),
