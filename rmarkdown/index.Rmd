...
-   Link to [code](https//marine-ecologist.github.io/spatialtools/rotate-polygon.R)
...
-   Link to [code](https://marine-ecologist.shinyapps.io/draw-plots/)
-   Link to [shiny example](https://marine-ecologist.shinyapps.io/draw-plots/)

<https://marine-ecologist.shinyapps.io/draw-plots/> </br> </br>
...
### Interactive raster data visualisation
...
Leaflet Drawing, Cropping, and Raster Integration

Dynamic site selection tool for selecting habitat criteria. Includes capacity to rotate polygons in `leaflet` and dynamically sample underlying raster layers.

![](images/draw-plots.gif)

Example includes simulated raster data of varying gridcell sizes (Temperature, Sedimentation, DHW, Wave Exposure, Chlorophyll, Salinity) and a "restoration score" (basic additive algorithm for categorical raster layers).
